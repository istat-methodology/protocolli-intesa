...
def main():
    parser = argparse.ArgumentParser(description="Report puliti V4 da JSON arricchito")
    parser.add_argument("input_json", help="Percorso del JSON enriched_2.4")
    parser.add_argument("-o", "--output-dir", default="report_output_v4", help="Cartella output")
