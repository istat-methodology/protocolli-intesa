...
soggetti_csv = Path(r"G:\develpment\protocolli-intesa\output\reports\step_3.1\soggetti_unici_puliti.csv")
output_dir = Path(r"G:\develpment\protocolli-intesa\output\reports\step_3.2")
